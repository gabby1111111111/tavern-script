...
当前稳定版本为 v0.3.0，公开安装请使用固定标签 `杠杠の调音室-v0.3.0`。
...
```ts
import 'https://testingcf.jsdelivr.net/gh/gabby1111111111/tavern-script@杠杠の调音室-v0.3.0/dist/杠杠の调音台/index.js';
```

加载后，在扩展设置中应看到标题为“杠杠の调音室 v0.3.0”的设置抽屉。仓库继续保留原来的 `杠杠の调音台` 技术路径，以兼容既有安装地址和设置。
